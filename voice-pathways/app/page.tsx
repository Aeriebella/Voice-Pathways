...
export default function VoicePathways() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-violet-50 to-white text-gray-800">
      <header className="p-6 text-center flex flex-col items-center gap-3">
        <nav className="mt-2 flex gap-6 text-sm text-gray-600">
          <a href="#home" className="hover:underline">Home</a>
          <a href="#services" className="hover:underline">Services</a>
          <a href="#about" className="hover:underline">About</a>
          <a href="#apply" className="hover:underline">Apply</a>
        </nav>
        <img src="/logo.png" alt="Voice Pathways logo" className="h-20 w-auto" />
        ...
        <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <Card className="rounded-2xl shadow-xl backdrop-blur bg-white/70">
            <CardContent className="p-6">
              ...
              <p className="mt-2">Welcome to Voice Pathways – your personal voice coaches, where your voice is treated with care, intention, and respect. Here, your journey is never rushed, judged, or forced into a mold. Instead, it is guided with clarity, compassion, and purpose.<br/><br/>Voice Pathways offers targeted vocal feminization instruction, without the fluff. Our focus is on helping you reach your goals as quickly and efficiently as possible, while minimizing discomfort along the way. Every lesson is thoughtfully designed to support your growth, reinforce your unique identity, and help you feel more at home in your voice.<br/><br/>We offer a range of lesson formats to meet you where you are — from your first evaluation, to focused training sessions, to continued artistic exploration. Lessons are available in paid format, and on Sundays, completely free while training slots are available.<br/><br/>It is our sincere pleasure to walk beside you on this journey, offering the care, encouragement, and gentle guidance you deserve, as you step into your new voice, with confidence!</p>
            </CardContent>
          </Card>
        </motion.section>
        ...
        <motion.section id="about" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <Card className="rounded-2xl shadow-xl backdrop-blur bg-white/70">
            <CardContent className="p-6">
              ...
              <p className="mt-2 text-gray-700">Voice Pathways is dedicated to compassionate, results-focused voice coaching. Our approach blends technique, care, and clear guidance to help you feel confident and supported at every step.<br/><br/>With over seven years of experience teaching voice, we have worked with students from across the globe and supported a wide range of dialects and accents. This diversity has shaped a flexible, personalized approach that meets you where you are and honors your personal goals.</p>
            </CardContent>
          </Card>
        </motion.section>
        ...
        <motion.section id="testimonials" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <Card className="rounded-2xl shadow-xl backdrop-blur bg-white/70 relative overflow-hidden">
            ...
            <CardContent className="p-6 relative">
              ...
              <div className="mt-6 text-center text-sm text-gray-600 italic">No testimonials have been shared yet. Be the first to add your voice to the Voice Pathways community.</div>
              ...
              <div className="mt-8 border-t pt-6">
                ...
                <form className="mt-4 grid gap-3 max-w-md mx-auto">
                  <input className="border p-2 rounded" placeholder="Name or Initials" />
                  <textarea className="border p-2 rounded" placeholder="Your testimonial" />
                  <Button className="rounded-full px-6 py-2 shadow">Submit Testimonial</Button>
                </form>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl shadow-lg">
            <CardContent className="p-6">
              ...
              <form action="mailto:yourbusiness@email.com" method="post" encType="text/plain" className="grid gap-3">
                ...
                <Button type="submit" className="rounded-full px-6 py-2 shadow-lg">Send Application</Button>
              </form>
            </CardContent>
          </Card>
        </motion.section>
